 ...
 * @generated
 */
public class FactorsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case FactorsPackage.ABS_SOCIAL_FACTORS: {
			AbsSocialFactors absSocialFactors = (AbsSocialFactors) theEObject;
			T result = caseAbsSocialFactors(absSocialFactors);
			if (result == null)
		...
		case FactorsPackage.ABS_PSYCHOLOGICAL_FACTORS: {
			AbsPsychologicalFactors absPsychologicalFactors = (AbsPsychologicalFactors) theEObject;
			T result = caseAbsPsychologicalFactors(absPsychologicalFactors);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FactorsPackage.IMPACTED_FACTOR: {
			ImpactedFactor impactedFactor = (ImpactedFactor) theEObject;
			T result = caseImpactedFactor(impactedFactor);
			if (result == null)
				result = caseFactor(impactedFactor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Impacted Factor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Impacted Factor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseImpactedFactor(ImpactedFactor object) {
		return null;
	}
