 ...
 * @generated
 */
public class psychoFactor_pkgSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case psychoFactor_pkgPackage.PSYCHOLOGICAL_FACTOR: {
