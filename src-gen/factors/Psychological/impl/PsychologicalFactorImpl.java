...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Psychological Factor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link factors.Psychological.impl.PsychologicalFactorImpl#getName <em>Name</em>}</li>
 *   <li>{@link factors.Psychological.impl.PsychologicalFactorImpl#getAffectedfactor <em>Affectedfactor</em>}</li>
 *   <li>{@link factors.Psychological.impl.PsychologicalFactorImpl#getOther <em>Other</em>}</li>
 *   <li>{@link factors.Psychological.impl.PsychologicalFactorImpl#getLevel <em>Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PsychologicalFactorImpl extends MinimalEObjectImpl.Container implements PsychologicalFactor {
	...
	protected EClass eStaticClass() {
		return NewPackage2Package.Literals.PSYCHOLOGICAL_FACTOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NewPackage2Package.PSYCHOLOGICAL_FACTOR__NAME,
					oldName, name));
	}
	...
	public EList<AffectedFactors> getAffectedfactor() {
		if (affectedfactor == null) {
			affectedfactor = new EObjectContainmentEList<AffectedFactors>(AffectedFactors.class, this,
					NewPackage2Package.PSYCHOLOGICAL_FACTOR__AFFECTEDFACTOR);
		}
	...
	public void setOther(String newOther) {
		...
		other = newOther;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NewPackage2Package.PSYCHOLOGICAL_FACTOR__OTHER,
					oldOther, other));
	}
	...
	public void setLevel(Level newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NewPackage2Package.PSYCHOLOGICAL_FACTOR__LEVEL,
					oldLevel, level));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case NewPackage2Package.PSYCHOLOGICAL_FACTOR__AFFECTEDFACTOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case NewPackage2Package.PSYCHOLOGICAL_FACTOR__NAME:
			return getName();
		case NewPackage2Package.PSYCHOLOGICAL_FACTOR__AFFECTEDFACTOR:
			return getAffectedfactor();
		case NewPackage2Package.PSYCHOLOGICAL_FACTOR__OTHER:
			return getOther();
		case NewPackage2Package.PSYCHOLOGICAL_FACTOR__LEVEL:
			return getLevel();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case NewPackage2Package.PSYCHOLOGICAL_FACTOR___COMPUTE_IMPACT__FACTORIMPACT:
