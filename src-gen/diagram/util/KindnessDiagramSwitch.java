 ...
 * @generated
 */
public class KindnessDiagramSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static KindnessDiagramPackage modelPackage;
	 ...
	 * @generated
	 */
	public KindnessDiagramSwitch() {
		if (modelPackage == null) {
			modelPackage = KindnessDiagramPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case KindnessDiagramPackage.ABS_KINDNESS_OPPORTUNITY: {
			AbsKindnessOpportunity absKindnessOpportunity = (AbsKindnessOpportunity) theEObject;
			T result = caseAbsKindnessOpportunity(absKindnessOpportunity);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case KindnessDiagramPackage.ABS_KINDNESS_ENTITY: {
