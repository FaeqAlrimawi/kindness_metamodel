...
public abstract class SocialFactorImpl extends MinimalEObjectImpl.Container implements SocialFactor {
	...
	protected EClass eStaticClass() {
		return SocialFactor_pkgPackage.Literals.SOCIAL_FACTOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SocialFactor_pkgPackage.SOCIAL_FACTOR__NAME, oldName,
					name));
	}
	...
	public EList<AffectedFactors> getAffectedfactor() {
		if (affectedfactor == null) {
			affectedfactor = new EObjectContainmentEList<AffectedFactors>(AffectedFactors.class, this,
					SocialFactor_pkgPackage.SOCIAL_FACTOR__AFFECTEDFACTOR);
		}
	...
	public void setOther(String newOther) {
		...
		other = newOther;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SocialFactor_pkgPackage.SOCIAL_FACTOR__OTHER,
					oldOther, other));
	}
	...
	public void setLevel(Level newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SocialFactor_pkgPackage.SOCIAL_FACTOR__LEVEL,
					oldLevel, level));
	}
			...
			if (connection != oldConnection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SocialFactor_pkgPackage.SOCIAL_FACTOR__CONNECTION, oldConnection, connection));
			}
		}
		return connection;
	}
	...
	public void setConnection(AbsConnection newConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SocialFactor_pkgPackage.SOCIAL_FACTOR__CONNECTION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SocialFactor_pkgPackage.SOCIAL_FACTOR__AFFECTEDFACTOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SocialFactor_pkgPackage.SOCIAL_FACTOR__NAME:
			return getName();
		case SocialFactor_pkgPackage.SOCIAL_FACTOR__AFFECTEDFACTOR:
			return getAffectedfactor();
		case SocialFactor_pkgPackage.SOCIAL_FACTOR__OTHER:
			return getOther();
		case SocialFactor_pkgPackage.SOCIAL_FACTOR__LEVEL:
			return getLevel();
		case SocialFactor_pkgPackage.SOCIAL_FACTOR__CONNECTION:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case SocialFactor_pkgPackage.SOCIAL_FACTOR___COMPUTE_IMPACT__FACTORIMPACT:
